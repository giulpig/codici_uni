 /**
  * MyVectorGenericsTester
  *
  * Classe di prova della classe MyVectorGenerics.
  * @see MyVectorGenerics
  *
  * @version 9-Dec-2013
  * @author Adriano Luchetta
  */
import java.util.Scanner;
public class MyVectorGenericsTester
{
   public static void main(String[] args)
   {
      Scanner in = new Scanner(System.in);
      MyVectorGenerics<String>  v1 = new MyVectorGenerics<String>();
      MyVectorGenerics<Integer> v2 = new MyVectorGenerics<Integer>();
