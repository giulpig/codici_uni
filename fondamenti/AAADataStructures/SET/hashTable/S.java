/**
 * FONDAMENTI DI INFORMATICA - GR. 4 Prova di Programmazione del 29-01-2020
 *
...
public class S<E extends Comparable> implements Set<E> {
   ...
   private class SetIterator<T> implements Iterator<T> {
       ...
       * iteratore
       * 
       * @throws IllegalStateException se il metodo next non e' stato prima chiamato o
       *                               il metodo remove è stato chiamato dopo l'ultima
   ...
   /**
    * restituisce nell'array specificato gli elementi dell'insieme ordinati secondo
    ...
    *                                        specificato e' minore della dimensione
    *                                        dell'insieme
    */
